...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/certbot-nginx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12830&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/certbot-nginx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `certbot-nginx` can be installed with:

```
conda install certbot-nginx
```

It is possible to list all of the versions of `certbot-nginx` available on your platform with:
